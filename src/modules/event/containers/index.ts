...
import { ViewParticipantsComponent } from './view-group-participants/view-group-participants.component';
...
export * from './view-group-participants/view-group-participants.component';
